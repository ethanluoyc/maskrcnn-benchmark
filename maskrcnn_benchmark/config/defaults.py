...
# InteractNet options (1704.07333)
_C.MODEL.ROI_HUMAN_HEAD = CN()
_C.MODEL.ROI_HUMAN_HEAD.FEATURE_EXTRACTOR = "ResNet50Conv5ROIFeatureExtractor"
_C.MODEL.ROI_HUMAN_HEAD.PREDICTOR = "HumanPredictor"
_C.MODEL.ROI_HUMAN_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_HUMAN_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_HUMAN_HEAD.POOLER_SCALES = (1.0 / 16,)
_C.MODEL.ROI_HUMAN_HEAD.NUM_ACTIONS = 10
# Hidden layer dimension when using an MLP for the RoI box head
_C.MODEL.ROI_HUMAN_HEAD.MLP_HEAD_DIM = 1024
# GN
_C.MODEL.ROI_HUMAN_HEAD.USE_GN = False
# Dilation
_C.MODEL.ROI_HUMAN_HEAD.DILATION = 1
_C.MODEL.ROI_HUMAN_HEAD.CONV_HEAD_DIM = 256
_C.MODEL.ROI_HUMAN_HEAD.NUM_STACKED_CONVS = 4
# Misc
